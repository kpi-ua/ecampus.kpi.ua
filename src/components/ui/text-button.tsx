...
const textButtonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none [&_svg]:shrink-0 cursor-pointer",
  {
    variants: {
      variant: {
        primary: "text-basic-blue text-primary-foreground hover:text-brand-700 disabled:text-neutral-400",
      ...
      size: {
        small: "text-sm [&_svg]:size-[16px] leading-[16px]",
        medium: "text-base [&_svg]:size-[20px] leading-[20px]",
        big: "text-lg [&_svg]:size-[24px] leading-[24px]",
      },
    },
    defaultVariants: {
      variant: "primary",
...
export interface TextButtonProps
  extends LinkProps, VariantProps<typeof textButtonVariants> {
  asChild?: boolean;
  loading?: boolean;
