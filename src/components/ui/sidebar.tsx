...
const SidebarGroup = ({ className, ref, ...props }: React.ComponentProps<'div'>) => {
  return (
    <div
      ...
      data-sidebar="group"
      className={cn(
        "relative flex w-full min-w-0 flex-col p-2 after:absolute after:bottom-0 after:left-[calc(16px+0.5rem)] after:right-[calc(16px+0.5rem)] after:h-px after:bg-neutral-divider after:content-['']",
        className,
      )}
      {...props}
    />
...
const SidebarGroupLabel = ({
  ...
  return (
    <Comp
      ...
      className={cn(
        'flex h-8 shrink-0 items-center rounded-md px-2 text-xs font-medium text-sidebar-foreground/70 outline-hidden ring-sidebar-ring transition-[margin,opa] duration-200 ease-linear focus-visible:ring-2 [&>svg]:size-[24px] [&>svg]:shrink-0',
...
const SidebarGroupAction = ({
  ...
  return (
    <Comp
      ...
      className={cn(
        'absolute right-3 top-3.5 flex aspect-square w-5 items-center justify-center rounded-md p-0 text-sidebar-foreground outline-hidden ring-sidebar-ring transition-transform hover:bg-sidebar-accent hover:text-sidebar-accent-foreground focus-visible:ring-2 [&>svg]:size-[24px] [&>svg]:shrink-0',
