...
const Contacts = () => (
  <div className="row">
    <div className="col-md-12">
      ...
      Адреса констуркторського бюро:{' '}
      <a href="https://goo.gl/maps/UUNyXm7wFiw">
        Україна, м. Київ, вул. Політехнічна 14-в
      </a>
      , корпус 13, 4 поверх, 25 кабінет.
      <br />
      Тел.: <a href="tel:+380442048006">+380 (44) 204 80 06</a>
      <br />
      Тел/факс.:<a href="tel:+380444549845">+38 (044) 454 98 45</a>
      <br />
