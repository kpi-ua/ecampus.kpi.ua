...
const Contacts = () => (
  <div className="row">
    <div className="col-md-12">
      ...
      Якщо у вас є питання, ви можете надіслати його на email служби підтримки: <a href="mailto:ecampus@kpi.ua">ecampus@kpi.ua</a><br />
      ...
      Дзовнть нам:
      <ul>
        <li>тел.: <a href="tel:+380442048004">+380 (44) 204 80 04</a></li>
        <li>тел/факс.:<a href="tel:+380444549845">+38 (044) 454 98 45</a></li>
      </ul>
      <br/>

      <h3>Кориснi посилання</h3>
