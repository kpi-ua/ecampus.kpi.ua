...
const SocialForbidden = () => (
  <div className="row">
    <div className="col-md-12">
      ...
      соціальні мережі, вам необхідно вказати в налаштуваннях вашого користувача
      той же емайл, до якого прив'язана ваша сторінка в соціальній мережі.
      <br />
      <div className="text-center">
        <img
          alt="forbidden"
          className="img-responsive sad-cat"
