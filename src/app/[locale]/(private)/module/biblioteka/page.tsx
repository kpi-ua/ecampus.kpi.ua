...
import { getBibliotekaDepartments } from '@/actions/biblioteka.actions';
...
export default async function BibliotekaPage() {
  ...
  const departments = await getBibliotekaDepartments();
  return (
    <SubLayout pageTitle={t('title')}>
      <div className="col-span-full flex w-full min-w-0 flex-col gap-6 pb-8">
        <BibliotekaTabs active="departments" />
        <div className="flex flex-col gap-2">
          <Heading3 className="leading-xl text-2xl lg:leading-xl lg:text-2xl">{t('departments.title')}</Heading3>
