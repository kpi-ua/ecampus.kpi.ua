...
export const MODULES: Module[] = [
  ...
  { name: 'ratingnpp', isExternal: true, group: 'ratingnpp' },
  { name: 'ratingnpp2021', isExternal: true, group: 'ratingnpp' },
  { name: 'ratingnpp2022', isExternal: true, group: 'ratingnpp' },
  { name: 'ratingnpp2023', isExternal: true, group: 'ratingnpp' },
  { name: 'ratingnpp2024', isExternal: true, group: 'ratingnpp' },
