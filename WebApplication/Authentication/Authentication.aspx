<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="Authentication.aspx.cs" Inherits="WebApplication.Authentication.WebForm1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
    ...
    <div id="form" class="form-horizontal">
        ...
        <div id="divSaveIn" class="form-group">
        ...
        <div id="divBtn" class="form-group">
            <asp:Button ID="Enter" runat="server" CssClass="btn btn-primary" Text="Вхід" OnClick="Enter_Click" />
            <asp:Button ID="Cancel" runat="server" CssClass="btn btn-primary" Text="Відміна" OnClick="Cancel_Click" />
        </div>
    </div>
