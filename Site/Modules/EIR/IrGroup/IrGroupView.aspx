<%@ Page Title="Перегляд групи ЕІР" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="IrGroupView.aspx.cs" Inherits="Site.Modules.EIR.IrGroup.IrGroupView" %>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            $(document).on("click", ".irLink", function (e) {
                ...
                e.preventDefault();
                window.open("/Modules/EIR/CardView.aspx", "_self");
            });
