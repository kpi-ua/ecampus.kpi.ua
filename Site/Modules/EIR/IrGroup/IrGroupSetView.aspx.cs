...
namespace Site.Modules.EIR.IrGroup
{
    public partial class IrGroupSetView : Core.SitePage
    {
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            _subdivisionId = Convert.ToInt32(Request.QueryString["subdivisionId"]);
            ...
            {
                url = Campus.SDK.Client.BuildUrl("IrGroup", "GetAllIrGroups", new { SessionId, subdivisionId = _subdivisionId });

                urlSubdivision = Campus.SDK.Client.BuildUrl("Subdivision", "GetSubdivisionData", new { SessionId, dcSubdivisionId = _subdivisionId });
