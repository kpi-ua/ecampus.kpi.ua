<%--<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Table.aspx.cs" Inherits="Site.Modules.SubSystems.GSVO.Table" %>--%>
<%@ Page Title="ОПП ГСВО" Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="Table.aspx.cs" Inherits="Site.Modules.SubSystems.GSVO.Table" %>
