...
<asp:Content ID="body_content" ContentPlaceHolderID="body" runat="server">
    ...
    <h4 style="margin:10px; ">Виберіть напрям спеціальності за освітньо-кваліфікаційним рівнем</h4>
    <div class="main-block">
        <asp:TreeView ID="TreeView" runat="server" ExpandDepth="0" Width="100%" AutoGenerateDataBindings="False" ImageSet="Arrows"  OnLoad="TreeView_Load" OnSelectedNodeChanged="TreeView_SelectedNodeChanged">
        </asp:TreeView>
    </div>         
</asp:Content>